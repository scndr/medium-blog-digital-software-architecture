 ...
 * 2021-03-04T16:20:17.637+01:00
 * Generated source version: 3.2.4
 *
 */
@WebServiceClient(name = "SumService",
                  wsdlLocation = "file:/C:/dev/eclipse-workspace/pv-personal/spring-boot-cxf-wssecurity-client/src/main/resources/wsdl/SumService.wsdl",
...
public class SumService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/dev/eclipse-workspace/pv-personal/spring-boot-cxf-wssecurity-client/src/main/resources/wsdl/SumService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SumService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/dev/eclipse-workspace/pv-personal/spring-boot-cxf-wssecurity-client/src/main/resources/wsdl/SumService.wsdl");
        }
        WSDL_LOCATION = url;
    }
